  ...
  return (
    <section className="hero-stack home-forest">
      ...
      <article className="panel-card review-entry-card home-entry-card home-entry-review">
        <button className="review-entry-action" type="button" onClick={() => navigate('/review')}>
          <span className="review-entry-leaf" aria-hidden="true">
            叶
          </span>
          <span className="review-entry-copy">
            <strong>去收今天的小树叶</strong>
            <span>今天已收集 {reviewSummary.todayLeaves} 片</span>
          </span>
          <span className="review-entry-arrow" aria-hidden="true">
            →
          </span>
        </button>
      </article>
